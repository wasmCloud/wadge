...
import (
	...
	terminaloutput "go.wasmcloud.dev/wadge/bindings/wasi/cli/terminal-output"
)

// TerminalOutput represents the imported type alias "wasi:cli/terminal-stderr@0.2.1#terminal-output".
//
