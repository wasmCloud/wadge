...
import (
	...
	terminalinput "github.com/rvolosatovs/west/examples/go/http/bindings/wasi/cli/terminal-input"
)
...
//go:wasmimport wasi:cli/terminal-stdin@0.2.1 get-terminal-stdin
//go:noescape
