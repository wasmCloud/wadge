...
// RecNested represents the record "wadge-test:sync/sync#rec-nested".
//
//	record rec-nested {
//		foo: string,
//	}
...
// Rec represents the record "wadge-test:sync/sync#rec".
//
//	record rec {
//		nested: rec-nested,
//	}
...
// Primitives represents the record "wadge-test:sync/sync#primitives".
//
//	record primitives {
//		a: u8,
//		b: u16,
...
// Res represents the imported resource "wadge-test:sync/sync#res".
//
//	resource res
