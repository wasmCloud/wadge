...
// Package leftpad represents the imported interface "wadge-test:leftpad/leftpad@0.1.0".
package leftpad
...
// InputStream represents the imported type alias "wadge-test:leftpad/leftpad@0.1.0#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wadge-test:leftpad/leftpad@0.1.0#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// StreamError represents the imported type alias "wadge-test:leftpad/leftpad@0.1.0#stream-error".
//
