...
import (
	...
	"go.wasmcloud.dev/wadge/tests/go/wasi/bindings/wasi/filesystem/types"
)

// Descriptor represents the imported type alias "wasi:filesystem/preopens@0.2.1#descriptor".
//
