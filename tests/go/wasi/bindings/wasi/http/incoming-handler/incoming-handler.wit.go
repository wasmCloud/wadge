...
// IncomingRequest represents the exported type alias "wasi:http/incoming-handler@0.2.1#incoming-request".
//
// See [types.IncomingRequest] for more information.
type IncomingRequest = types.IncomingRequest

// ResponseOutparam represents the exported type alias "wasi:http/incoming-handler@0.2.1#response-outparam".
//
