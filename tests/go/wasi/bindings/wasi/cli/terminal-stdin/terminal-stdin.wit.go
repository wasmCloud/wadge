...
import (
	...
	terminalinput "go.wasmcloud.dev/wadge/tests/go/wasi/bindings/wasi/cli/terminal-input"
)

// TerminalInput represents the imported type alias "wasi:cli/terminal-stdin@0.2.1#terminal-input".
//
